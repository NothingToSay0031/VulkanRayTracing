...
struct glTFScene : public RenderScene {
  ...
  void add_mesh(cstring filename, cstring path, StackAllocator* temp_allocator,
                AsynchronousLoader* async_loader) override;
  void shutdown(Renderer* renderer) override;

  void prepare_draws(Renderer* renderer, StackAllocator* scratch_allocator,
                     SceneGraph* scene_graph) override;

  void get_mesh_vertex_buffer(glTF::glTF& gltf_scene, u32 buffers_offset, i32 accessor_index,
                              u32 flag, BufferHandle& out_buffer_handle, u32& out_buffer_offset,
                              u32& out_flags);
  ...
  void fill_pbr_material(glTF::glTF& gltf_scene, Renderer& renderer, glTF::Material& material,
