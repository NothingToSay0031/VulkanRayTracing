...
enum Enum { Add, Subtract, RevSubtract, Min, Max, Count };
...
static const char* s_value_names[] = {"Add", "Subtract", "RevSubtract", "Min", "Max", "Count"};
...
enum Enum { Never, Less, Equal, LessEqual, Greater, NotEqual, GreaterEqual, Always, Count };
...
static const char* s_value_names[] = {"Never",    "Less",         "Equal",  "LessEqual", "Greater",
                                      "NotEqual", "GreaterEqual", "Always", "Count"};
...
namespace CullMode {
enum Enum { None, Front, Back, Count };

enum Mask { None_mask = 1 << 0, Front_mask = 1 << 1, Back_mask = 1 << 2, Count_mask = 1 << 3 };

static const char* s_value_names[] = {"None", "Front", "Back", "Count"};
...
enum Enum { Zero, All, Count };

enum Mask { Zero_mask = 1 << 0, All_mask = 1 << 1, Count_mask = 1 << 2 };

static const char* s_value_names[] = {"Zero", "All", "Count"};
...
enum Enum { True, False, Count };

enum Mask { True_mask = 1 << 0, False_mask = 1 << 1, Count_mask = 1 << 2 };

static const char* s_value_names[] = {"True", "False", "Count"};
...
enum Enum { Keep, Zero, Replace, IncrSat, DecrSat, Invert, Incr, Decr, Count };
...
static const char* s_value_names[] = {"Keep",   "Zero", "Replace", "IncrSat", "DecrSat",
                                      "Invert", "Incr", "Decr",    "Count"};
...
static const char* s_value_names[] = {"UNKNOWN",
                                      "R32G32B32A32_TYPELESS",
                                      "R32G32B32A32_FLOAT",
                                      "R32G32B32A32_UINT",
                                      "R32G32B32A32_SINT",
...
enum Enum { Vertex, Index, Constant, Indirect, Structured, Count };
...
static const char* s_value_names[] = {"Vertex",   "Index",      "Constant",
                                      "Indirect", "Structured", "Count"};
...
enum Enum { Immutable, Dynamic, Stream, Staging, Readback, Count };
...
static const char* s_value_names[] = {"Immutable", "Dynamic", "Stream", "Staging", "Count"};
...
namespace IndexType {
enum Enum { Uint16, Uint32, Count };

enum Mask { Uint16_mask = 1 << 0, Uint32_mask = 1 << 1, Count_mask = 1 << 2 };

static const char* s_value_names[] = {"Uint16", "Uint32", "Count"};
...
//
//     enum Mask {
//         Vertex_mask = 1 << 0, Fragment_mask = 1 << 1, Geometry_mask = 1 << 2, Compute_mask = 1 <<
//         3, Hull_mask = 1 << 4, Domain_mask = 1 << 5, Count_mask = 1 << 6
//     };
//
//     static const char* s_value_names[] = {
//         "Vertex", "Fragment", "Geometry", "Compute", "Hull", "Domain", "Count"
...
enum Mask { Nearest_mask = 1 << 0, Linear_mask = 1 << 1, Count_mask = 1 << 2 };

static const char* s_value_names[] = {"Nearest", "Linear", "Count"};
...
enum Enum { Repeat, Mirrored_Repeat, Clamp_Edge, Clamp_Border, Count };
...
static const char* s_value_names[] = {"Repeat", "Mirrored_Repeat", "Clamp_Edge", "Clamp_Border",
                                      "Count"};
...
static const char* s_value_names[] = {
    "Clear", "Set", "Copy",  "CopyInverted", "Noop",        "Invert",    "And",        "Nand", "Or",
...
namespace QueueType {
enum Enum { Graphics, Compute, CopyTransfer, Count };
...
static const char* s_value_names[] = {"BindPipeline",
                                      "BindResourceTable",
                                      "BindVertexBuffer",
                                      "BindIndexBuffer",
                                      "BindResourceSet",
...
static const char* s_value_names[] = {
    "Buffer",        "Texture",    "Pipeline",    "Sampler",     "DescriptorSetLayout",
    "DescriptorSet", "RenderPass", "Framebuffer", "ShaderState", "TextureView",
    "PagePool"};
...
static const char* s_value_names[] = {"Immediate", "VSync", "VSyncFast", "VSyncRelaxed", "Count"};
