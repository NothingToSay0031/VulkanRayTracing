...
static const u8 k_max_image_outputs =
    8;  // Maximum number of images/render_targets/fbo attachments usable.
static const u8 k_max_descriptor_set_layouts = 8;  // Maximum number of layouts in the pipeline.
static const u8 k_max_shader_stages =
    5;  // Maximum simultaneous shader stages. Applicable to all different type of pipelines.
static const u8 k_max_descriptors_per_set =
    32;  // Maximum list elements for both descriptor set layout and descriptor sets.
...
struct BlendState {
  ...
  BlendState& set_color(VkBlendFactor source_color, VkBlendFactor destination_color,
                        VkBlendOp color_operation);
  BlendState& set_alpha(VkBlendFactor source_color, VkBlendFactor destination_color,
                        VkBlendOp color_operation);
...
struct SamplerCreation {
  ...
  SamplerCreation& set_address_mode_uvw(VkSamplerAddressMode u, VkSamplerAddressMode v,
...
struct DescriptorSetLayoutCreation {
  ...
  DescriptorSetLayoutCreation& add_binding(VkDescriptorType type, u32 index, u32 count,
                                           cstring name);
...
struct DescriptorSetCreation {
  ...
  DescriptorSetCreation& texture_sampler(TextureHandle texture, SamplerHandle sampler,
                                         u16 binding);  // TODO: separate samplers from textures
...
struct RenderPassOutput {
  ...
  RenderPassOutput& set_depth_stencil_operations(RenderPassOperation::Enum depth,
...
struct RenderPassCreation {
  ...
  RenderPassCreation& add_attachment(VkFormat format, VkImageLayout layout,
  ...
  RenderPassCreation& set_depth_stencil_operations(RenderPassOperation::Enum depth,
                                                   RenderPassOperation::Enum stencil);
...
inline bool has_depth(VkFormat value) { return is_depth_only(value) || is_depth_stencil(value); }
...
struct ImageBarrier {
  ...
  ResourceState destination_state =
      RESOURCE_STATE_UNDEFINED;  // Source state is saved in the texture.
