...
//
//
i64 time_from(i64 starting_time) { return time_now() - starting_time; }
...
//
//
double time_from_seconds(i64 starting_time) { return time_seconds(time_from(starting_time)); }
...
//
//
double time_microseconds(i64 time) { return (double)time; }

//
//
double time_milliseconds(i64 time) { return (double)time / 1000.0; }

//
//
double time_seconds(i64 time) { return (double)time / 1000000.0; }
